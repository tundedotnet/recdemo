				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav>
						<ul class="nav navbar-nav">
							<li id="index" class="<?php if($page == 'index') echo 'active'; ?>"><a href="index.php">Home</a></li>
								...
								<ul class="dropdown-menu multi-column columns-3">
									...
									<div class="col-sm-6">
										<ul class="multi-column-dropdown">
											...
											<li><a href="genres.php?ref=<?php echo $all_genres[$i] ?>"><?php echo $all_genres[$i] ?></a></li>
											<?php } ?>
							...
							<li id="list" class="<?php if($page == 'list') echo 'active'; ?>"><a href="list.php">A - z list</a></li>
							<li id="contact" class="<?php if($page == 'contact') echo 'active'; ?>"><a href="contact.php">Contact Us</a></li>
						</ul>
					</nav>
				</div>
			</nav>	
