			...
			<div class="movie-browse-agile">
				...
				<div class="browse-agile-w3ls general-w3ls">
					...
					<div class="tittle-head">
						<h4 class="latest-text">KEYWORD: <?php echo '"' . $searchtext . '"' . ' (' . $total_records . ' RECORDS)' ;?> </h4>
						<div class="container">
					...
					<div class="container">
						<input type="hidden" id="ref" value="<?php echo $searchtext; ?>">
						<div class="browse-inner" id="browse-inner">
							...
							<?php
								...
								$result = $movie->search($searchtext, $start_from, $limit);
